        ...
        <table id="table" class="table border table-hover">
            ...
            <tbody>
                ...
                <?php elseif ($level == "Admin") : ?>
                    <?php $query = mysqli_query($conn, "SELECT * FROM pengaduan INNER JOIN masyarakat ON pengaduan.nik=masyarakat.nik INNER JOIN tanggapan ON pengaduan.id_pengaduan=tanggapan.id_pengaduan INNER JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas ORDER BY tanggapan.tgl_tanggapan DESC"); ?>
                <?php endif; ?>
                <?php while ($result = mysqli_fetch_array($query)) : ?>
                    <tr>
                        ...
                        <td><?php echo $result['tgl_tanggapan']; ?></td>
                                            ...
                                            <div class="col">
                                                ...
                                                <?php elseif ($level == "Petugas") : ?>
                                                    <div class="mb-3 container">
                                                        ...
                                                        <textarea class="form-control" name="tanggapan" id="exampleFormControlTextarea1" rows="5" required><?= $result['tanggapan'] ?></textarea>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
